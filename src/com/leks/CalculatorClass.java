...
public class CalculatorClass {
    ...
    public static String calc(String input) {
        ...
        while (i < input.length()) {
            if (input.charAt(i) == '+' || input.charAt(i) == '-' || input.charAt(i) == '*' || input.charAt(i) == '/') {
                ...
                count++;
                if (count > 1)
                return "Введено выражение с более, чем одним оператором";
            }
            i++;
                      }
        ...
        i = 0;
        while (i < n) {
            firstOperand = firstOperand + input.charAt(i);
            i++;
        }
        //нахождение 2-го операнда
        i = n + 1;
        while (i < input.length()) {
            secondOperand = secondOperand + input.charAt(i);
        ...
        if ((firstOperand.equals("1") ||
            ...
            return (calculArabic(firstOperand, action, secondOperand));
            ...
            return (calculRoman(firstOperand, action, secondOperand));


        } else {

            return "Вы ввели неверные значения";
        }
    }

    public static String calculArabic(String a, char b, String c) {
        int result = 0;
    ...
    public static String calculRoman(String a, char b, String c) {
        ...
        if (Integer.parseInt(firstNumberArabic) <= Integer.parseInt(secondNumberArabic) && b == '-') {
            ...
            return "Вы ввели неверное выражение (1-й операнд должен быть больше 2-го опернда)";
        }
    ...
    public static String romanToArabic(String operand) {
    ...
    public static String arabicToRoman(String numberRoman) {
